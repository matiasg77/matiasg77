...
- **AWS:** EC2 · S3 · Lambda · API Gateway · App Runner · ECS · EKS · EventBridge · CloudFront · Cognito · IAM · Glue · Athena · DynamoDB · Aurora RDS · QuickSight  
- **GCP:** App Engine · BigQuery · Pub/Sub  
- **IBM Cloud** (Watson Assistant, Cloudant, Functions)  
